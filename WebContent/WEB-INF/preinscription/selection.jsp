		 ...
		 <div class="row">
		 	...
		 	<div class="col-md-5">
		 		<div class="input-group">
					...
					<select name="portail" id="portailAdd" class="form-control custom-select" style="width: 100%;" tabindex="-1" aria-hidden="true">
		 	...
		 	<div class="col-md-6">
		 		<div class="input-group">
						...
						<select name="id_vagueAdd" id="id_vagueAdd" class="form-control custom-select" style="width: 100%;" tabindex="-1" aria-hidden="true">
							<!--<option selected="1">1er vague</option>-->
